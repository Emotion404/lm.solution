package lm.solution.console.jaxws;

import lm.solution.service.jaxws.SquareRootServer;
import lm.solution.service.jaxws.SquareRootServerImpl;
...
public class JaxWsTest {
    ...
    public void publishAndClient(){
        ...
        try {
            ...
            QName qName=new QName("http://jaxws.service.solution.lm/","SquareRootServerImplService");
