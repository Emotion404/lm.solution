...
namespace TsqlCodeWeb
{
    public class MyDbContext: DbContext
    {
        ...
        {
            builder.Entity<TSqlCodeFirstCloumnType>();
        }
    }

    public static class DBInitiallier
    {
        public static void Initial(MyDbContext context )
        {
    ...
    /*
     * CREATE TABLE [dbo].[TSqlCodeFirstCloumnType](
